...
export default function MapScreen() {
    ...
    const getMinPrice = (venue: Venue) => {
        ...
        // Get venue open status
        const getVenueStatus = (venue: Venue) => {
            if (!venue.opening_hours) return { isOpen: false, label: 'Closed' };

            // Handle string format (e.g. "08:00-22:00") or structured object
            // Simplified for now: assume if string exists, check time
            // Real implementation should parse opening_hours object per day
            /*
             opening_hours: {
            ...
            */
            ...
            if (typeof venue.opening_hours === 'object' && venue.opening_hours !== null) {
                const todayHours = (venue.opening_hours as any)[currentDay];
