...
import { updateNotificationPreferencesAction } from '@/app/actions/settings-actions'
              ...
              {activeSection === 'privacy' && (
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <button className="w-full flex items-center justify-between px-4 py-3 border-2 border-red-200 rounded-lg hover:bg-red-50 transition-colors text-red-600">
                      <div className="text-left">
